...
export function OrderHistoryPage() {
  ...
  const orders: Order[] = [
    {
      id: "88291",
      orderId: "#ORD-88291",
      paymentTime: "2024-05-12 09:45",
      vouchers: ["Super Sale SB 10%", "Bonus Gift Card"],
      total: 124.5,
    },
    {
      id: "88245",
      orderId: "#ORD-88245",
      paymentTime: "2024-05-10 14:20",
    ...
    },
    {
      id: "88190",
      orderId: "#ORD-88190",
      paymentTime: "2024-05-08 18:15",
      vouchers: ["VIP Pass", "Drink Voucher", "Merch Discount"],
      total: 210.99,
    },
    {
      id: "88112",
      orderId: "#ORD-88112",
      paymentTime: "2024-05-05 11:30",
      vouchers: ["Daily Deal"],
      total: 45.0,
    },
    {
      id: "88001",
      orderId: "#ORD-88001",
      paymentTime: "2024-05-01 16:55",
      vouchers: ["Spring Promo"],
      total: 89.2,
    },
    {
      id: "87955",
      orderId: "#ORD-87955",
      paymentTime: "2024-04-28 10:05",
      vouchers: ["Mega Discount", "Free Shipping"],
      total: 320.0,
    },
    {
      id: "87820",
      orderId: "#ORD-87820",
      paymentTime: "2024-04-25 13:40",
      vouchers: ["Mini Snack"],
      total: 12.5,
    },
  ];
  ...
  const filteredOrders = orders.filter((o) =>
    ...
    o.vouchers.some(v => v.toLowerCase().includes(searchQuery.toLowerCase()))
  );
